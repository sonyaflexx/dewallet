...
const ReceiveModal: React.FC = () => {
    ...
    return (
        ...
        <div className={`bg-primary-bg relative rounded-t-[20px] px-5 pt-5 w-full h-[95vh] transition-transform ${modalStore.isReceiveModalActive ? '' : 'translate-y-[2000px]'}`}>
            ...
            <p className='font-medium text-center my-7'>Receive <span className='font-semibold'>TON or Jettons</span> via <span className='font-semibold'>The Open Network</span> to this address. You must send at least <span className='font-semibold'>0.1 TON or 0.1 Jetton</span> or more to deposit.</p>
